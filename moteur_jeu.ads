...
generic
    ...
    --retourne true si le joueur J est le prochain à jouer
    with function Joue(E : Etat ; J : Joueur) return Boolean;
...
private
  ...
  --  function Affiche_Maillon(M : Maillon);
...
--    type Maillon is record
  ...
  --  package Liste_Maillon is new Liste_Generique(Maillon, Affiche_Maillon);
